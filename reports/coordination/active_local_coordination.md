...
- C's next independent acceptance runs against the exact A candidate after the local commit. It must verify browser/detail parity, viewer-private invariance, the five-helper zero-reference gate, and clean stop without changing production.
