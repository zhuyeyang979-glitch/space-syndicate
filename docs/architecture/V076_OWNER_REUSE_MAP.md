...
| Card source authorization | Unassigned pending atomic private Direct Action cutover | PR #65 | `ADAPT_AS_CONSUMER` | Current Owner count is 0; capability and membership patterns only, and the old port cannot execute. |
