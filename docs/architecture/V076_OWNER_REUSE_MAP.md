...
This map enforces one Owner per domain at the exact current product subject
`9f8659c8e3745c4f0c6bc398030c289e4291db31` / tree
`7a5f976fd09c4d4d69cf70b806760b7b2242ffff`. Consumers may adapt data or
contracts, but they may not inherit authority by association. STEP09, STEP11,
and STEP12 are `REGRESSED_WITH_EVIDENCE` pending exact-subject production
revalidation; the prior receipts remain immutable historical evidence only,
and production cutover and Human Green are not currently claimed.
