...
- 终局结算新增“终局总结”和“玩家概览”，同时写入日志和局势排名页，解释赢家、钱从哪里来、每个席位的最终资金/城收/卡牌收入/终局情报现金/角色收入/城市数、关键卡牌、怪兽影响、AI 主要路线、关键城市、存活城市/毁坏区域。
...
- 终局倒计时测试现在也验证终局总结会出现在日志和排名文本中，并覆盖关键卡牌、怪兽影响、AI 路线、玩家概览与城收字段。
