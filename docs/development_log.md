...
- 已建立 Godot headless 烟测：
  ...
  - 验证 AI 会评分手牌、匿名出牌、参与同时批次竞价、自动回应合约并记录候选与收益样本
  - 验证合约牌展示后独立签约窗口
...
1. 继续把 AI 行为扩展到卡牌归属竞猜、城市业主标注、怪兽诱导路线与更长期的经济规划，让 AI 能在多周期里围绕“最终钱最多”优化。
