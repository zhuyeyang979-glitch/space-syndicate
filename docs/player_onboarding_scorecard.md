...
| 一步一目标 | 4 | ScenarioCoach 单主 CTA；首局 CTA 现在会自动落到推荐区域；买牌 CTA 会自动寻找合法牌架，并把星球旋转到目标区；重复卡住仍只保留一个“定位下一步”主 CTA | 真人复验首局 10 分钟 |
...
1. 运行牌桌细焦点：分区焦点链已覆盖顶部、牌轨、星球、详情、手牌、行动、竞价；牌轨、手牌和区域牌架卡已经支持确认键；星球地图焦点下方向键会切区并旋转到目标区域，确认键可打开牌架；下一步做真人手柄型号复验。
