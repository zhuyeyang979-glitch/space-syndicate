...
$ready=([string]$manifest.schema-ceq'Pr90ProbeBV2ResultRecoveryToolingManifestV1'-and[string]$manifest.status-ceq'READY'-and[bool]$manifest.preformal_authorization_eligible-and-not[bool]$manifest.startup_probe_b_authorization_eligible-and
 [string]$manifest.tooling_head_sha-ceq$head-and[string]$manifest.tooling_tree_sha-ceq$tree-and[string]$manifest.tooling_parent_sha-ceq$parent-and[string]$parent-ceq'2ebb2df9a1c649e8527b045939e9d6e47b98f17c'-and
 [int]$manifest.new_tooling_commit_count-eq1-and[int]$manifest.new_tooling_diff_count-eq12-and[int]$manifest.new_tooling_modified_count-eq10-and[int]$manifest.new_tooling_added_count-eq2-and[int]$manifest.tooling_scope_violation_count-eq0-and[int]$manifest.product_code_change_count-eq0-and[int]$manifest.product_test_change_count-eq0-and[int]$manifest.tooling_file_hash_mismatch_count-eq0-and
 [int]$manifest.base_selftest_pass_count-eq230-and[int]$manifest.new_selftest_case_count-ge40-and[int]$manifest.new_selftest_pass_count-eq[int]$manifest.new_selftest_case_count-and[int]$manifest.total_selftest_failure_count-eq0-and
 [int]$manifest.frozen_input_count-eq241-and[string]$manifest.frozen_input_hash_inventory_sha256-ceq'af5e309da4a512bbee1cdf3118e69ac243782715484757410702234f75d94f50'-and[int]$manifest.runtime_reachable_tooling_hash_mismatch_count-eq0)
