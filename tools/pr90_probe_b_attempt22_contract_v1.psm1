...
function Get-Pr90FormalCombatPresentationGateV1 {
    ...
    try{
        ...
        $mainEvidenceSemanticsGreen=$false;$baselineAcceptance=$null;$acquireAcceptance=$null;$cardAcceptance=$null;$missionAcceptance=$null;$trackCandidate=$null;$handCandidate=$null;$trackPrivatePayload=$null;$handPrivatePayload=$null
        try{
            ...
            $mainEvidenceSemanticsGreen=([string](Get-Pr90FormalRequestedValueV1 -Evidence $evidenceByPrefix.seed -Name 'text')-ceq[string]$ScenarioWitness.seed_input_value-and[string]$ScenarioWitness.seed_input_value-ceq'900626424'-and[int64]$ScenarioWitness.deterministic_match_seed-eq900626424-and
                ...
                [string]$trackPrivatePayload.card_kind-ceq'normal_card'-and[int]$trackPrivatePayload.level-eq1-and[string]$trackPrivatePayload.primary_color-ceq[string]$ScenarioWitness.acquired_card_primary_color-and[string]$ScenarioWitness.acquired_card_primary_color-ceq'life'-and[int]$trackPrivatePayload.local_slot_index-eq5-and$trackPrivatePayload.claimable-is[bool]-and[bool]$trackPrivatePayload.claimable-and[string]$trackPrivatePayload.claimability_state-ceq'claimable'-and[string]$trackPrivatePayload.origin_class-ceq[string]$ScenarioWitness.acquired_card_origin_class-and[string]$ScenarioWitness.acquired_card_origin_class-ceq'standard'-and[string]$trackPrivatePayload.asset_cost_profile-ceq'standard_rank_1'-and[int]$trackPrivatePayload.primary_asset_cost-eq[int]$ScenarioWitness.acquired_card_primary_asset_cost-and[int]$ScenarioWitness.acquired_card_primary_asset_cost-eq2-and$trackPrivatePayload.starter_badge-is[bool]-and-not[bool]$trackPrivatePayload.starter_badge-and
                ...
                $null-ne$handPrivatePayload-and[string]$handPrivatePayload.definition_id-ceq[string]$ScenarioWitness.staged_card_definition_id-and[string]$ScenarioWitness.staged_card_definition_id-ceq[string]$ScenarioWitness.acquired_card_definition_id-and[string]$handPrivatePayload.instance_id-ceq[string]$ScenarioWitness.staged_card_instance_id-and-not[string]::IsNullOrWhiteSpace([string]$ScenarioWitness.staged_card_instance_id)-and[string]$ScenarioWitness.staged_card_instance_id-cne[string]$ScenarioWitness.acquired_card_instance_id-and[string]$handPrivatePayload.origin_class-ceq[string]$ScenarioWitness.staged_card_origin_class-and[string]$ScenarioWitness.staged_card_origin_class-ceq'standard'-and[string]$handPrivatePayload.primary_color-ceq[string]$ScenarioWitness.staged_card_primary_color-and[string]$ScenarioWitness.staged_card_primary_color-ceq'life'-and[string]$handPrivatePayload.asset_cost_profile-ceq'standard_rank_1'-and[int]$handPrivatePayload.primary_asset_cost-eq[int]$ScenarioWitness.staged_card_primary_asset_cost-and[int]$ScenarioWitness.staged_card_primary_asset_cost-eq2-and$handPrivatePayload.starter_badge-is[bool]-and-not[bool]$handPrivatePayload.starter_badge-and
        ...
        $witnessGreen=($null-ne$ScenarioWitness-and[string]$ScenarioWitness.schema-ceq'SpaceSyndicateFormalCombatScenarioWitnessV1'-and[string]$ScenarioWitness.status-ceq'PASS'-and
            ...
            [int]$ScenarioWitness.initial_public_military_hand_candidate_count-eq0-and$preAcquireHandGreen-and[string]$ScenarioWitness.acquired_card_node_path-like'*/TrackRail/TrackCard_05'-and[int]$ScenarioWitness.track_acquired_delta-eq1-and[int]$ScenarioWitness.facility_advance_action_count-eq15-and$facilityStepsGreen-and
...
function Test-Pr90Attempt22FormalRepairSelfTestReceiptV1 {
    ...
    if([string]$Receipt.schema-cne'Pr90ProbeBV2ResultRecoveryToolingSelfTestV1'-or[string]$Receipt.status-cne'PASS'-or
       [string]$revision-cne'PR90_ATTEMPT22_FORMAL_COMBAT_PRIVATE_PAYLOAD_IDENTITY_REPAIR_V16'-or[int]$Receipt.base_tooling_selftest_pass_count-ne326-or
