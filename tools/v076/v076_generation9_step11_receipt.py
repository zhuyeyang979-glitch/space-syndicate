...
TOOLING_SEAL_PATH = "reports/reuse/full_convergence/generation9/generation9_receipt_tooling_repair_seal_004.json"
SUPERSEDED_AUTHORIZATION_PATH = "reports/reuse/full_convergence/generation9/generation9_authorization_manifest_repair_003.json"
AUTHORIZATION_PATH = "reports/reuse/full_convergence/generation9/generation9_authorization_manifest_repair_004.json"
AUTHORIZATION_SIDECAR_PATH = AUTHORIZATION_PATH + ".sha256"
ENVIRONMENT_SEAL_PATH = "reports/reuse/full_convergence/generation9/generation9_environment_seal_repair_004.json"
...
def _validate_authorization(project: GitProject, authorization_head: str, tooling_head: str, report: Report) -> tuple[dict[str, Any] | None, bytes | None]:
    ...
    expected = {
        ...
        "tooling_repair_reason_code": "POWERSHELL_JSON_DATE_COERCION_DISABLED",
    }
