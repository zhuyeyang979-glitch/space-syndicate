...
if([string]$sealObject.status-cne'SEALED'-or[string]$sealObject.tooling_head_sha-cne$ExpectedToolingHead-or[string]$sealObject.tooling_tree_sha-cne$ExpectedToolingTree-or[string]$sealObject.canonical_payload_sha256-cne(Get-Pr90ProbeBCanonicalSha256 $sealObject)){$errors.Add('TOOLING_SEAL_CONTRACT_MISMATCH')}
if([string]$toolingManifestObject.status-cne'READY'-or-not[bool]$toolingManifestObject.startup_probe_b_authorization_eligible-or[string]$toolingManifestObject.tooling_head_sha-cne$ExpectedToolingHead-or[string]$toolingManifestObject.tooling_tree_sha-cne$ExpectedToolingTree-or
...
$pairs=@(
    ...
    @('probe_b_result_path','probe_b_result_sha256'),@('probe_b_attestation_path','probe_b_attestation_sha256'),@('probe_b_finalizer_result_path','probe_b_finalizer_result_sha256'),@('preformal_dry_run_path','preformal_dry_run_sha256'),
