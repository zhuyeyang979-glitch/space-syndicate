...
$toolingFieldRows=@(
    ...
    @('probe_b_controller_sha256','tools/pr90_exact_clone_probe_b_controller_v1.ps1'),@('probe_b_result_builder_sha256','tools/pr90_exact_clone_probe_b_result_builder_v1.ps1'),@('probe_b_attestation_builder_sha256','tools/pr90_exact_clone_probe_b_attestation_builder_v1.ps1'),@('probe_b_recovery_controller_sha256','tools/pr90_exact_clone_probe_b_postrun_recovery_controller_v1.ps1'),@('probe_b_recovery_contract_module_sha256','tools/pr90_probe_b_attempt22_contract_v1.psm1'),@('probe_b_frozen_input_inventory_builder_sha256','tools/pr90_probe_b_v2_frozen_input_inventory_builder_v1.ps1'),
