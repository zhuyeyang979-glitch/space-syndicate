...
if($pb){$v=Get-Content -Raw -LiteralPath $config.probe_b_result_path|ConvertFrom-Json -Depth 100;$pb=[string]$v.schema-ceq'Pr90ExactCloneProbeBV2ResultV1'-and[string]$v.probe_id-ceq'pr90-exact-clone-startup-probe-b-v2-001'-and[string]$v.status-ceq'PASS'-and[int]$v.milestone_pass_count-eq12-and[string]$v.import_finalizer_status-ceq'PASS'-and
    ...
    [string]$v.tooling_seal_sha256-ceq[string]$config.probe_b_execution_tooling_seal_sha256-and[string]$v.result_recovery_tooling_head_sha-ceq$toolingHead-and[string]$v.result_recovery_tooling_tree_sha-ceq$toolingTree-and[string]$v.result_recovery_tooling_seal_sha256-ceq[string]$config.tooling_seal_sha256-and[int]$v.runtime_reachable_tooling_hash_mismatch_count-eq0-and
...
if($recoveryReceiptGreen){$recoveryReceipt=Get-Content -Raw -LiteralPath $config.probe_b_recovery_receipt_path|ConvertFrom-Json -Depth 100;$recoveryReceiptGreen=[string]$recoveryReceipt.schema-ceq'Pr90ProbeBV2ResultRecoveryReceiptV1'-and[string]$recoveryReceipt.status-ceq'PASS'-and[string]$recoveryReceipt.result_sha256-ceq[string]$config.probe_b_result_sha256-and[string]$recoveryReceipt.attestation_sha256-ceq[string]$config.probe_b_attestation_sha256-and
    ...
    [string]$recoveryReceipt.result_recovery_tooling_head_sha-ceq$toolingHead-and[string]$recoveryReceipt.result_recovery_tooling_tree_sha-ceq$toolingTree-and[string]$recoveryReceipt.result_recovery_tooling_manifest_sha256-ceq[string]$config.tooling_manifest_sha256-and[string]$recoveryReceipt.result_recovery_tooling_seal_sha256-ceq[string]$config.tooling_seal_sha256-and
    [string]$recoveryReceipt.recovery_controller_sha256-ceq[string]$tm.probe_b_recovery_controller_sha256-and[string]$recoveryReceipt.recovery_contract_module_sha256-ceq[string]$tm.probe_b_recovery_contract_module_sha256-and
...
if($pba){$v=Get-Content -Raw -LiteralPath $config.probe_b_attestation_path|ConvertFrom-Json -Depth 100;$pba=[string]$v.schema-ceq'Pr90ExactCloneProbeBV2AttestationV1'-and[string]$v.status-ceq'SEALED'-and[int]$v.unbound_evidence_count-eq0-and[bool]$v.bracketed_sample_model-and[int]$v.matched_listener_process_enrichment_count-eq1-and
    ...
    [string]$v.result_recovery_tooling_head_sha-ceq$toolingHead-and[string]$v.result_recovery_tooling_tree_sha-ceq$toolingTree-and[string]$v.result_recovery_tooling_manifest_sha256-ceq[string]$config.tooling_manifest_sha256-and[string]$v.result_recovery_tooling_seal_sha256-ceq[string]$config.tooling_seal_sha256-and[int]$v.runtime_reachable_tooling_hash_mismatch_count-eq0}
...
$result=[pscustomobject][ordered]@{
    ...
    probe_b_execution_tooling_head_sha=[string]$config.probe_b_execution_tooling_head_sha;probe_b_execution_tooling_tree_sha=[string]$config.probe_b_execution_tooling_tree_sha;probe_b_execution_tooling_seal_sha256=[string]$config.probe_b_execution_tooling_seal_sha256;probe_b_recovery_receipt_sha256=[string]$config.probe_b_recovery_receipt_sha256
