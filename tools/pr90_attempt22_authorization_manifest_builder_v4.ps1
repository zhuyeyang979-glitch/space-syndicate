...
$additions=[ordered]@{
    ...
    probe_b_recovery_tooling_head_sha=[string]$config.tooling_head_sha;probe_b_recovery_tooling_tree_sha=[string]$config.tooling_tree_sha;probe_b_recovery_tooling_manifest_sha256=Get-Pr90ProbeBSha256 $config.tooling_manifest_path;probe_b_recovery_tooling_seal_sha256=Get-Pr90ProbeBSha256 $config.tooling_seal_path;runtime_reachable_tooling_hash_mismatch_count=0
