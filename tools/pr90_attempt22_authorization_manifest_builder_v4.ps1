...
$additions=[ordered]@{
    ...
    attempt22_authorization_missing_contract_count=0;godot_gui_path=[IO.Path]::GetFullPath([string]$config.godot_gui_path);godot_gui_sha256=Get-Pr90ProbeBSha256 $config.godot_gui_path;godot_console_path=[IO.Path]::GetFullPath([string]$config.godot_console_path);godot_console_sha256=Get-Pr90ProbeBSha256 $config.godot_console_path
