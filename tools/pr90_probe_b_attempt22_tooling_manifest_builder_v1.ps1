...
$baseHead='a57148bba1eaa0d180e47fbed72119cf224a82dd';$baseTree='3847cf4fe14497166ce833e996780cf49634359b'
$sealedBaseManifestSha256='d472f66ad612d7b7cfd3aae62238f5a842018becf3af6bb2ae2cb6d273503a55';$sealedBaseSealSha256='e52557c99361adf2a3b76258c47ffa7b6a9e05e42439abefb0891fff6d8a26c8';$sealedBaseSelfTestSha256='79a9ce248f43b99ce900954e451cab06506cd7c5810ae3d4cd8c25f2af281166';$sealedFrozenInputSha256='3a064504628f4168d74b2558fa7473fbe3f00288e79deec5362184ce71f6e2d5'
$frozenRecoveryHead='44f5ef84185f3488dfde7551a787571337b0f531';$frozenRecoveryTree='f58146e6325f6ce08cfda4d807be6133c9a0373a'
if($ExpectedBaseToolingManifestSha256-cne$sealedBaseManifestSha256-or$ExpectedBaseToolingSealSha256-cne$sealedBaseSealSha256-or$ExpectedBaseSelfTestSha256-cne$sealedBaseSelfTestSha256-or$ExpectedFrozenInputInventorySha256-cne$sealedFrozenInputSha256){throw 'Frozen a57148bb authority hash arguments are not exact.'}
...
if([string]$baseManifest.schema-cne'Pr90ProbeBV2ResultRecoveryToolingManifestV1'-or[string]$baseManifest.status-cne'READY'-or[string]$baseManifest.tooling_head_sha-cne$baseHead-or[string]$baseManifest.tooling_tree_sha-cne$baseTree-or[string]$baseManifest.canonical_payload_sha256-cne(Get-Pr90ProbeBCanonicalSha256 $baseManifest)-or
   [string]$baseSeal.schema-cne'Pr90ProbeBV2ResultRecoveryToolingSealV1'-or[string]$baseSeal.status-cne'SEALED'-or[string]$baseSeal.tooling_head_sha-cne$baseHead-or[string]$baseSeal.tooling_tree_sha-cne$baseTree-or[string]$baseSeal.manifest_sha256-cne$ExpectedBaseToolingManifestSha256-or[string]$baseSeal.canonical_payload_sha256-cne(Get-Pr90ProbeBCanonicalSha256 $baseSeal)){throw 'Frozen a57148bb Tooling authority contract mismatch.'}
if([string]$baseSelfTest.schema-cne'Pr90ProbeBV2ResultRecoveryToolingSelfTestV1'-or[string]$baseSelfTest.selftest_revision-cne'PR90_ATTEMPT22_FINALIZER_CONSOLE_IDENTITY_REPAIR_V11'-or[string]$baseSelfTest.status-cne'PASS'-or[int]$baseSelfTest.new_selftest_case_count-ne233-or[int]$baseSelfTest.total_tooling_selftest_pass_count-ne559-or[int]$baseSelfTest.total_tooling_selftest_failure_count-ne0-or
   (Get-Pr90ProbeBSha256 $BaseSelfTestPath)-cne[string]$baseManifest.new_selftest_sha256){throw 'Frozen a57148bb Tooling self-test is not the exact 233-case V11 receipt.'}
if(-not(Test-Pr90Attempt22FormalRepairSelfTestReceiptV1 $newSelfTest)-or[int]$newSelfTest.new_selftest_case_count-ne242-or
   [string]$newSelfTest.selftest_case_name_inventory_sha256-cne'bad8ff5393370c6b2b459f7c2a4ff48f9af838f9a3be0dd645eefdcfa964338e'){throw 'Attempt22 phase-2 runtime readiness repair self-test version or exact case inventory mismatch.'}
...
$eligible=($scopeErrors.Count-eq0-and$worktreeBlobMismatch-eq0-and$runtimeMismatch.Count-eq0-and$authorizedRuntimeChangeCount-eq2-and$productCodeChangeCount-eq0-and$productTestChangeCount-eq0-and[int]$newSelfTest.new_selftest_case_count-eq242-and[string]$newSelfTest.selftest_case_name_inventory_sha256-ceq'bad8ff5393370c6b2b459f7c2a4ff48f9af838f9a3be0dd645eefdcfa964338e'-and(Test-Pr90Attempt22FormalRepairSelfTestReceiptV1 $newSelfTest))
