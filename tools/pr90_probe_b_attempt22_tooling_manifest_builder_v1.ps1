...
if(-not(Test-Pr90Attempt22FormalRepairSelfTestReceiptV1 $newSelfTest)-or[int]$newSelfTest.new_selftest_case_count-ne153-or
   [string]$newSelfTest.selftest_case_name_inventory_sha256-cne'2b1098235d73bc33f296964bb873516dd280029f31a5b7a9e2f1413a9d160b1f'){throw 'Attempt22 nested canonical identity self-test version or exact case inventory mismatch.'}
...
$eligible=($scopeErrors.Count-eq0-and$worktreeBlobMismatch-eq0-and$runtimeMismatch.Count-eq0-and$authorizedRuntimeChangeCount-eq2-and$productCodeChangeCount-eq0-and$productTestChangeCount-eq0-and[int]$newSelfTest.new_selftest_case_count-eq153-and[string]$newSelfTest.selftest_case_name_inventory_sha256-ceq'2b1098235d73bc33f296964bb873516dd280029f31a5b7a9e2f1413a9d160b1f'-and(Test-Pr90Attempt22FormalRepairSelfTestReceiptV1 $newSelfTest))
