...
Local patch ID: `alpha04c-initial-scan-signal11-v1`

Effective build ID: `0.9.6+alpha04c.signal11.1`
...
- The local patch preimports fresh caches in Godot recovery mode, serializes filesystem scans, makes initial scan and reload operations queryable, gates HTTP polling until initial import has remained ready for 30 seconds, requires caller-owned mutation request IDs, and binds wrappers to one editor process identity.
