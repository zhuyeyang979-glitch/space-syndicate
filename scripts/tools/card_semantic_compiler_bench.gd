...
func run_bench() -> void:
	...
	_expect(int(service_summary.get("active_count", 0)) == 288, "service_active_count")
	_expect(int(service_summary.get("projection_only_count", 0)) == 60, "service_projection_count")
