...
func run_bench() -> void:
	...
	_expect(int(service_summary.get("active_count", 0)) == 328, "service_active_count")
	_expect(int(service_summary.get("projection_only_count", 0)) == 20, "service_projection_count")
