...
func _run() -> void:
	...
	var private_target: Dictionary = overlay.district_supply_presentation_target_snapshot()
	_check(
	...
	var public_target: Dictionary = overlay.district_supply_presentation_target_snapshot()
	_check(
