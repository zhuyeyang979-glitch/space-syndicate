...
func build_from_map_view(map_view: Control) -> Dictionary:
	...
	return {
		...
		"sun_direction": surface_snapshot.get("sun_direction", Vector3.RIGHT),
		...
		"terrain_surface_samples": surface_snapshot.get("terrain_surface_samples", []),
		"terrain_by_region": surface_snapshot.get("terrain_by_region", {}),
		"geography_complexity": str(surface_snapshot.get("geography_complexity", "STANDARD")),
		"land_ocean_profile": str(surface_snapshot.get("land_ocean_profile", "BALANCED")),
		"authoritative_surface_connected": bool(surface_snapshot.get("authoritative_surface_connected", false)),
...
func _empty_payload() -> Dictionary:
	return {
		...
		"authoritative_surface_connected": false,
		"mode": "empty",
		"globe_blend": 1.0,
		"globe_mode": true,
