...
func debug_snapshot() -> Dictionary:
	return {
		...
		"sceneized": true,
		"player_position_decoration_count": 0,
	}
...
func _draw() -> void:
	...
	# PlanetBoard owns the full stage-space fill. Keep this layer transparent
	# outside the globe so the map remains the permanent center stage.
