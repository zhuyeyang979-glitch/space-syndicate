...
func _theme_color(skill: Dictionary) -> Color:
	match str(skill.get("kind", "")):
		...
		"intel_city_reveal", "card_history_public_review", "card_history_subscription": return Color("#60a5fa")
...
func _use_case_text(source: Dictionary, skill: Dictionary, route_label: String) -> String:
	...
	var labels := {
		...
		"card_history_public_review": "公开证据复盘", "card_history_subscription": "私人履历订阅", "city_owner_guess": "猜城市业主", "queue": "排队结算", "event": "制造公开事件",
	}
...
func _rule_facts(source: Dictionary, skill: Dictionary) -> Array:
	...
	var numeric_facts := [
		...
		["miasma_count", "瘴气", "int"], ["reclaim_count", "回收瘴气", "int"], ["reveal_city_count", "查区域业主", "int"], ["history_review_count", "复盘履历", "int"], ["history_subscription_count", "订阅履历", "int"],
...
func _category_id(source: Dictionary, skill: Dictionary) -> String:
	...
	if kind in ["intel_city_reveal", "card_history_public_review", "card_history_subscription"]: return "intel"
	return "other"
