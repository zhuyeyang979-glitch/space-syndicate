...
const _CATALOG := [
	...
	},
	{
		...
		"passive": "在含静电蜂蜜的区域购买普通牌时，免费额外获得1张同区候选牌。",
	...
	},
	{
		"name": "幽幕播报社",
		"species": "暗频主持群",
		"trait": "专门编目匿名行动留下的公开残帧；擅长从公开证据整理私人嫌疑集合。",
		"passive": "残帧编目：每局可用2次。选择一条仍匿名的卡牌履历，只按公开时间、目标、牌种、阶段与公开资格生成私人嫌疑集合；安全证据不足时不消耗次数。",
		"card_history_residual_catalog_charges": 2,
		"flavor": "所有画面都是雪花屏，只有他们听得见雪花里谁在结账。",
	},
	{
		"name": "双边密约公证团",
		"species": "镜面章鱼律师",
		"trait": "从公开订单回执与牌轨残帧里整理证据链；知道更多，但不能免费公开证明。",
		"passive": "残帧编目：每局可用2次。选择一条仍匿名的卡牌履历，只按公开时间、目标、牌种、阶段与公开资格生成私人嫌疑集合；安全证据不足时不消耗次数。",
		"card_history_residual_catalog_charges": 2,
		"flavor": "他们盖章时会伸出第三只触手，专门整理没人愿意承认的公开证据。",
	},
	{
		"name": "碎光私探行会",
		"species": "棱镜游民",
		"trait": "把公开证据拆成互斥条件；不会给出答案，只会谨慎排除不可能者。",
		"passive": "公开证据排除：每局可用3次。选择一条仍匿名的卡牌履历，只按公开事实从私人嫌疑列表排除1名确定不可能的玩家；无安全排除项时不消耗次数。",
		"card_history_public_exclusion_charges": 3,
	...
	},
	{
		"name": "赤环航运托拉斯",
		"species": "红环渡航民",
		"trait": "经营海洋保险、航道租赁和绕行订单；最擅长从运输瓶颈里抽佣。",
		"passive": "己方含风暴珍珠的城市每分钟现金流额外+¥35；开局资金+¥50。",
	...
	},
	{
		"name": "黑潮风险基金",
		"species": "墨鳍量化体",
		"trait": "以商品市场的公开剧烈波动为食；适合金融买涨、做空和高风险出售路线。",
		"passive": "开局资金+¥70；每个商品市场周期中，第一次出售公开波动值达到12或以上的商品时，额外获得¥40。",
	...
	},
	{
		...
		"passive": "己方含轨迹墨水的区域设施每分钟现金流额外+¥40；开局资金+¥40。",
		"starting_cash_bonus": 40,
	...
	},
	{
		"name": "暗礁公证黑市",
		"species": "珊瑚印章群",
		"trait": "专门处理不该被看见的交易副本；擅长从公开痕迹排除不可能者。",
		"passive": "公开证据排除：每局可用1次。选择一条仍匿名的卡牌履历，只按公开事实从私人嫌疑列表排除1名确定不可能的玩家；无安全排除项时不消耗次数；开局资金+¥30。",
		"starting_cash_bonus": 30,
		"card_history_public_exclusion_charges": 1,
