...
static func compose(content_width: float = 1120.0) -> Dictionary:
	return {
		...
		"tooltip": "v0.6 规则速查：动态胜利、公开牌源、合并、破产与已退役旧规则。",
		"accent": Color("#93c5fd"),
		...
		"kpis": [
			...
			{"title": "普通牌从哪里买？", "body": "非商品普通牌进入公开动态市场，以牌面现金价格购买。", "meta": "购买入手牌；打出再付牌面资产。", "accent": Color("#4ade80")},
		...
		"keyword_legend": [
			...
			{"symbol": "市场", "label": "公开牌源", "body": "普通牌走公开动态市场", "accent": Color("#4ade80")},
		],
		...
		"modules": [
			...
			{"title": "▤ 公开动态市场", "body": "非商品普通牌公开挂牌、现金购买。", "meta": "购买费与出牌资产分开。", "accent": Color("#4ade80")},
