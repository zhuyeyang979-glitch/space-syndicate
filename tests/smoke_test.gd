...
func _run() -> void:
	...
	_expect(menu_body_label != null and menu_body_label.text.contains("怪兽生态｜") and menu_body_label.text.contains("公开行动类别") and menu_body_label.text.contains("怪兽牌在卡牌图鉴") and menu_body_label.text.contains("本页") and menu_body_label.text.contains("悬停预览") and menu_body_label.text.contains("双击详情"), "monster ecology dossier opens as a thumbnail atlas focused on public action effects while monster cards stay in the card codex")
