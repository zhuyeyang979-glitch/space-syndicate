...
func _run() -> void:
	...
	_expect(player_box != null and _container_label_text_contains(player_box, "首召怪兽") and _container_button_text_contains(player_box, "在选区首召"), "empty-field player panel prompts the starter monster first summon")
