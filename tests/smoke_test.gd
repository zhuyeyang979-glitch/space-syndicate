...
func _run() -> void:
	...
	_expect(player_box != null and _container_has_named_node(player_box, "MainActionDock") and _container_label_text_contains(player_box, "快捷") and _container_button_text_contains(player_box, "建城") and _container_button_text_contains(player_box, "牌架") and _container_button_text_contains(player_box, "买牌") and (_container_button_text_contains(player_box, "出牌") or _container_button_text_contains(player_box, "首召")), "player panel exposes a four-button board-game quick action dock for build, market, buy, and play")
...
func _verify_selected_district_card_interaction(main: Node, district_index: int) -> void:
	...
	var supply_state_rail := main.get("district_supply_state_rail") as HFlowContainer
