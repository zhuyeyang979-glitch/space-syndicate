...
$targetedAuthorization = $authorizationContract.targeted_owner_capture_diagnostic_v3
...
$realLedgerPaths = @(
    ...
    (Join-Path $gitCommonPath ([string]$authorizationContract.targeted_owner_capture_diagnostic_v3.quota_ledger_relative_path)),
