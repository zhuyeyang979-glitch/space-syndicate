...
func _run() -> void:
	...
	var target_after_full: Dictionary = overlay.district_supply_presentation_target_snapshot()
	...
	var target_after_live: Dictionary = overlay.district_supply_presentation_target_snapshot()
	...
	var target_after_rebind: Dictionary = overlay.district_supply_presentation_target_snapshot()
