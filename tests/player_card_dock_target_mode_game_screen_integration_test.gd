...
func _run() -> void:
	...
	var popup := screen.get_node("RegionSupplyPopup") as SpaceSyndicateRegionSupplyPopup
	...
	_expect(not popup.visible, "entering target-selection mode closes RegionSupplyPopup")
