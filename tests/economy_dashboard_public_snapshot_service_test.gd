...
func _source() -> Dictionary:
	return {
		...
		"product_entries": [
			{"name": "环晶电池", "price": 92, "base_price": 70, "gap": 22, "trend": 8, "tier": "高价档", "supply": 2, "demand": 5, "disrupted": 1, "volatility": 4, "weather": "需求+", "status_tags": ["热门"], "path": "70→92", "heat_score": 100, "cold_score": -20},
