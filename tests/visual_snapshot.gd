...
func _run() -> void:
	...
	_expect(goal_index < 0 and action_goal_index > tray_index and action_goal_index < first_summon_index, "next-step goal prompt lives at the top of the action tray")
	_expect(first_summon_index > tray_index and first_summon_index < district_action_index, "starter-summon prompt remains the first concrete action-tray decision for new testers")
