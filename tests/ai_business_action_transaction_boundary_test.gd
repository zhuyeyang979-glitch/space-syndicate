...
const BENCH_SCENE := preload("res://scenes/tools/AiBusinessActionTransactionBoundaryBench.tscn")
...
func _run() -> void:
	...
	print("AI_BUSINESS_ACTION_TRANSACTION_BOUNDARY_TEST|status=%s|checks=%d|failures=%d|details=%s" % [
