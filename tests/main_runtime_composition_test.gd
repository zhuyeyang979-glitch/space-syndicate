...
func _check_static_composition(main: Control) -> void:
	...
	var ai_card_strategy_query := main.get_node_or_null("RuntimeServices/RuntimeControllerHost/GameRuntimeCoordinator/AiCardStrategyQueryPort")
	var ai_region_knowledge_query := main.get_node_or_null("RuntimeServices/RuntimeControllerHost/GameRuntimeCoordinator/AiRegionKnowledgeQueryPort")
	var ai_city_inference_command := main.get_node_or_null("RuntimeServices/RuntimeControllerHost/GameRuntimeCoordinator/AiCityInferenceCommandPort")
	...
	_expect(ai_card_strategy_query != null and ai_card_strategy_query.scene_file_path == "res://scenes/runtime/AiCardStrategyQueryPort.tscn" and ai_card_strategy_query.has_method("route_id_for_card") and ai_card_strategy_query.has_method("development_routes") and not ai_card_strategy_query.has_method("to_save_data"), "GameRuntimeCoordinator owns one pure public AI card-strategy query port")
